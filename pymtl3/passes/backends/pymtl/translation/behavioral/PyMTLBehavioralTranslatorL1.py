#=========================================================================
# PyMTLBehavioralTranslatorL1.py
#=========================================================================
# Author : Peitian Pan
# Date   : Dec 23, 2019
"""Provide the level 1 PyMTL translator implementation."""
...
from .PyMTLBehavioralTranslatorL0 import PyMTLBehavioralTranslatorL0


class PyMTLBehavioralTranslatorL1( PyMTLBehavioralTranslatorL0, BehavioralTranslatorL1 ):
  ...
  def rtlir_tr_upblk_src( s, upblk, rtlir_upblk ):
    visitor = BehavioralRTLIRToPyMTLVisitorL1(s.is_pymtl_reserved)
...
#-------------------------------------------------------------------------
# BehavioralRTLIRToPyMTLVisitorL1
#-------------------------------------------------------------------------

class BehavioralRTLIRToPyMTLVisitorL1( bir.BehavioralRTLIRNodeVisitor ):
  ...
  def __init__( s, is_reserved ):
    ...
    s.SEQUENTIAL    = 2
    s.upblk_type    = s.NONE
    s._is_pymtl_reserved = is_reserved

  def is_pymtl_reserved( s, name ):
    return s._is_pymtl_reserved( name )
  ...
  def check_res( s, node, name ):
    if s.is_pymtl_reserved( name ):
      raise PyMTLTranslationError( s.blk, node,
        f"name {name} is a PyMTL reserved keyword!" )
  ...
  def visit_CombUpblk( s, node ):
    """Return the PyMTL representation of statements inside it."""
    blk_name = node.name
    src      = []
    body     = []
